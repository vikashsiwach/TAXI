...
const FinishRide = ({ setFinishRidePanel }) => {
  ...
  return (
    <div>
      ...
      <h3 className="flex justify-center text-2xl font-semibold mb-5">Finish this Ride</h3>
      ...
      <div className="flex gap-2 justify-between flex-col items-center">
        <div className="w-full mt-5">
          ...
          <div className="mt-6 w-full">
            <Link
              to="/captain-home"
              className="bg-green-600 w-full block text-center text-white font-semibold p-2 px-10 rounded-lg"
            >
              Finish Ride
            </Link>
            <p className="text-center bg-gray-200 mt-10 text-xs">
              Click on Finish Ride button if payment is done!
            </p>
          </div>
        </div>
      </div>
